...
Experience in supervised/unsupervised learning (sci-kit learn, XGBoost), natural language processing (NLTK), network analysis (NetworkX), and data visualization (Matplotlib) in Python

Experience in extracting data using SQL, and statistical analysis in R, and JMP

Basic Knowledge and application experience of Hadoop (HDFS and Spark) 

Certified as an advanced programmer in SAS

Experience in building VBA models and optimization models in Excel
